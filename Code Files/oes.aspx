<%@ Page Language="C#" AutoEventWireup="true" CodeFile="oes.aspx.cs" Inherits="_Default" %>
...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark ftco_navbar ftco-navbar-light" id="ftco-navbar">
	    <div class="container d-flex align-items-center">
	    	<a class="navbar-brand" href="oes.aspx">Online Examination System</a>
	      ...
	      <div class="collapse navbar-collapse" id="ftco-nav">
	        <ul class="navbar-nav ml-auto">
	          ...
	          <li class="nav-item"><a href="frmlogin_m.aspx" class="nav-link">LogIn</a></li>
	        </ul>
	      </div>
	    </div>
	  </nav>
