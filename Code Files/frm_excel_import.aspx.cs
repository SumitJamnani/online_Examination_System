...
public partial class frm_excel_import : System.Web.UI.Page
{
                ...
                if (dsExcel.Tables.Count > 0)
                {
                    ...
                    while (r < dsExcel.Tables[0].Rows.Count)
                    {
                        ...
                        if (subcode != "")
                        {
                            ...
                            query = "if not exists (select *from que_m where sub_id = '" + sub + "' and unit_id = "+unit+" and que_text ='" + que + "' )insert into que_m(sub_id,unit_id,que_text,o1,o2,o3,o4,correct_ans) values(" + sub + "," + unit + ",'" + que + "','" + o1 + "','" + o2 + "','" + o3 + "','" + o4 + "','" + ca + "')";
                            cn.modify(query);
